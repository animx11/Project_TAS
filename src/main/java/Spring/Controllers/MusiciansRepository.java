...
public class MusiciansRepository {
    ...
    @RequestMapping(value = "/musician", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public Iterable<Musicians> listMusicians(){
        return musiciansService.listMusicians();
    }

    @RequestMapping(value = "musician_by_id", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public Musicians getByParamId(@RequestParam("id") Integer id){
        return musiciansService.getById(id);
    }

    @RequestMapping(value = "/musician/{id}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public Musicians getByPublicId(@PathVariable("id") Integer id){
        return musiciansService.getById(id);
    }

    @RequestMapping(value = "/musician", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/musician", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/musician", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Musicians> delete(@RequestParam("id") Integer id){
        musiciansService.delete(id);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @RequestMapping(value = "/musician_by_firstName", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/musician_by_lastName", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/musician_by_pseudonym", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = "/musician_by_bandName", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
